...
static void mcs_lock(volatile mcs_lock_t *lock, volatile qnode_t *qn)
{
    volatile qnode_t *pred;
...
static void mcs_unlock(mcs_lock_t *lock, volatile qnode_t *qn)
{
    volatile qnode_t *t = qn->next;
